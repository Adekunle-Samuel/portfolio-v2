      ...
      <div className="flex items-start gap-6 py-8">
        ...
        <div className="flex flex-col gap-5 pt-1">
          <div className="flex flex-col gap-3">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-medium text-black tracking-[-0.02em] leading-[1.05]">
              Hi, I&apos;m {displayName}
            </h1>
            <p className="text-sm sm:text-base text-[#4a4a4a] leading-relaxed max-w-[460px]">
              {displayTagline}
            </p>
          </div>
